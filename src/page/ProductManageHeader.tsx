  ...
  return (
    <div className="mb-8">
      {/*
        ...
        * a screen that cannot afford it. From md up nothing moves. The event
        * page's twin.
        */}
      ...
      {/*
        ...
        * have reached anyway. They now live on the breadcrumb row above:
        * Preview as an icon, Back as the crumb it duplicated.
        *
